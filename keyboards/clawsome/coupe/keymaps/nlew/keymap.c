...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    *-----------------------------------------------------------------------
    *|CTRL|ALT |GUI |                SPACE            |GUI |ALT | FNM |CTRL|
    *-----------------------------------------------------------------------
    */
    [0] = LAYOUT_60_ansi(
        ...
        KC_LCTL,   KC_LALT,   KC_LGUI,                       KC_SPC,                              KC_RGUI,  KC_RALT,  FNM,       KC_RCTL),
   /*
    *-------------------------------------------------------------
    ...
    */
    [1] = LAYOUT_60_ansi(
        ...
        _______,            _______, _______, _______, _______, _______, KC_END,  KC_PGDN, _______, _______,   RESET,            _______,
